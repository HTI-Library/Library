class TranslationModel {
  ...
  TranslationModel.fromJson(Map<String, dynamic> json) {
    ...
    make_sure_that_you_write_the_same_password = json['make_sure_that_you_write_the_same_password'];

    please_login_to_add_or_remove_from_wish_list = json['please_login_to_add_or_remove_from_wish_list'];
    please_login_to_compare = json['please_login_to_compare'];
    please_login_to_add_or_remove_from_cart = json['please_login_to_add_or_remove_from_cart'];
    please_login_to_get_notifications = json['please_login_to_get_notifications'];
